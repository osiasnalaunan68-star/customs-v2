...
def parse_tariff(filepath: str) -> list:
    ...
    for line in lines:
        ...
        if m and current_chapter:
            ...
            # Columns: (3)=2024, (4)=2025, (5)=2026 Jan-Jul, (6)=2026 Jul-Dec, (7)=2027, (8)=2028
            rate_2026_jan = float(m.group(5))
            rate_2026_jul = float(m.group(6))
            # Use the higher of the two 2026 rates (conservative)
            rate_2026 = max(rate_2026_jan, rate_2026_jul)
